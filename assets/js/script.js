...
$(".list-group").on("click", "p", function() {
  ...
  $(".list-group").on("blur", "textarea", function() {
    ...
    //get parent ul's id attriute
    var status = $(this)
    .closest(".list-group")
    .attr("id")
    .replace("list-", "");

    //get the task position in the list of other elements
    var index = $(this)
...
$(".list-group").on("click", "span", function() {
  ...
  //automatically bring up calander
...
// value of due date changed now click outside window to make changes
...
//this makes the tasks draggable
...
//updates the pages every 30 min.
